                ...
                <SignIn
                  ...
                  appearance={{
                    elements: {
                      ...
                      headerTitle:
                        "font-montserrat font-bold text-2xl text-white hidden",
                      headerSubtitle:
                        "font-montserrat text-white/80 hidden",
                      ...
                      dividerText:
                        "font-montserrat text-white/70",
                      formFieldLabel:
                        "font-montserrat font-medium text-white/70",
                      formFieldInput:
                      ...
                      footerActionLink:
                        "text-legend-red font-montserrat font-medium hover:text-legend-red/80",
                      identityPreviewText:
                        "font-montserrat text-white",
                      identityPreviewEditButton:
                        "text-legend-red hover:text-legend-red/80",
